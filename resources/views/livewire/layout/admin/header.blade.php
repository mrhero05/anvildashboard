            ...
            <div
                ...
                <a class="relative hs-dropdown-toggle cursor-pointer align-middle rounded-full">
                    <img class="object-cover w-9 h-9 rounded-full"
                        src="{{ asset('spiketheme/assets/images/profile/user-1.jpg') }}" alt="" aria-hidden="true">
                </a>
                <div class="card hs-dropdown-menu transition-[opacity,margin] rounded-md duration hs-dropdown-open:opacity-100 opacity-0 mt-2 min-w-max  w-[200px] hidden z-[12] group-hover/profile:opacity-100 group-hover/profile:block group-hover/profile:right-0 group-hover/profile:absolute group-hover/profile:top-[25px]"
                    aria-labelledby="hs-dropdown-custom-icon-trigger">
                    <div class="card-body p-0 py-2">
                        ...
                        <div class="px-4 mt-[7px] grid">
                            <button
                                class="btn-outline-primary font-medium text-[15px] w-full hover:bg-blue-600 hover:text-white" wire:click="logout">Logout</button>
                        </div>
